...
public class SearchUtil
{
	...
	public static List getOperatorList(int dataType)
	{
		...
		switch (dataType)
		{
			...
			case DATATYPE_NUMERIC :
				operatorList.add(new NameValueBean(Operator.EQUALS_CONDITION,
						Operator.EQUALS_CONDITION));
				operatorList.add(new NameValueBean(Operator.NOT_EQUALS_CONDITION,
						Operator.NOT_EQUALS_CONDITION));
				operatorList.add(new NameValueBean(Operator.LESS_THAN, Operator.LESS_THAN));
				operatorList.add(new NameValueBean(Operator.LESS_THAN_OR_EQUALS,
						Operator.LESS_THAN_OR_EQUALS));
				operatorList.add(new NameValueBean(Operator.GREATER_THAN, Operator.GREATER_THAN));
				operatorList.add(new NameValueBean(Operator.GREATER_THAN_OR_EQUALS,
			...
			case DATATYPE_MULTI_ENUMERATED :
				...
				operatorList.add(new NameValueBean(Operator.NOT_IN_CONDITION,
						Operator.NOT_IN_CONDITION));
				break;
		}
	 ...
	 */
	public static SearchFieldData initSearchUIData(String dataType, String msgKey,
			String aliasName, String colName, String id, String opList, String valueList,
			String unitFieldKey)
	{
		//Initializing HTMLField class
		HTMLField oprationField = new HTMLField(createKey(aliasName, colName, true), id + "Combo",
				opList);
		...
		return new SearchFieldData(dataType, msgKey, oprationField, valueField, funcName,
				unitFieldKey);
	}
	...
	public static String getColumnDisplayName(int formId, String tableName, String columnName)
	{
		...
		if (searchFieldData != null)
		{
			...
			for (SearchFieldData element : searchFieldData)
			{
				String key = element.getValueField().getName();
				if (key.equals(name))
				{
					columnDisplayName = element.getLabelKey();
					break;
				}
			}
		}
